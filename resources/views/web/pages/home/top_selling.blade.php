<div class="container margin_60_35">
				...
				<div class="isotope-wrapper">
					<div class="row small-gutters">
						...
						@if(isset($top->price) && isset($top->price_new))
						<div class="col-6 col-md-4 col-xl-3 isotope-item sale">
							<div class="grid_item">
								...
								<a href="product-detail-1.html">
								<h3 class="d-block" style="max-width: 270px; height:50px; overflow: hidden;text-overflow: ellipsis;white-space: nowrap;">{{$top->name}}</h3>
								</a>
								<div class="price_box">
									<span class="new_price">{{number_format($top->price_new,0,",",".")}} Vnđ</span>
