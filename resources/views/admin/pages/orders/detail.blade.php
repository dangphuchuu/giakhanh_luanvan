<div class="modal fade text-left" id="order_detail{{$order->id}}" tabindex="-1" role="dialog" aria-labelledby="order_detail" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-full" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="order_detail">{{__("Order Number")}}: {{$order->id}} - {{__("Date of receipt")}}: {{$order->updated_at->format('d/m/Y')}}</h5>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="width: 150px">
                                <img style="width: 150px" src="https://res.cloudinary.com/{{env('CLOUD_NAME')}}/image/upload/{{ $orderPro->ProductsImage->first()->image }}.jpg">
                            </td>
